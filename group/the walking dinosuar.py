...
game = Game("the walking dinasour")
...
forest = game.new_location(
  "forest",
  "you are looking around at the empty forest")
...
nest = game.new_location(
  "nest",
"""A small area at the bottom of a cave,
to the west, there is one large egg""")
...
game.new_connection("large egg", forest, nest, [IN, WEST], [OUT, EAST])
